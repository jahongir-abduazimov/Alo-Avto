      ...
      <div className="max-w-sm mx-auto px-4 py-6">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <div className="text-center">
            <p className="text-sm text-gray-500 mb-4">Общая сумма штрафов</p>
            <div className="text-2xl font-bold text-red-600">3 840 000 UZS</div>
          </div>

          <div className="mt-6 space-y-3">
            <Button className="w-full bg-green-600 hover:bg-green-700 text-white h-12 font-medium">
              Оплатить штрафы
            </Button>
            <Button
              variant="outline"
              className="w-full border-gray-200 h-12 font-medium"
            >
              Скачать справку
            </Button>
          </div>
